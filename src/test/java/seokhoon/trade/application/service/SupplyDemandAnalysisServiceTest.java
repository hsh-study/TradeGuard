...
class SupplyDemandAnalysisServiceTest {
    ...
    private static StockInvestorFlow flow(LocalDate date,InvestorType type,String amount){return new StockInvestorFlow(null,"005930",date,type,null,new BigDecimal(amount),1,null,null,null,null,InvestorFlowSource.KIS,NOW,NOW);}
