    ...
    String render(OperationalDashboardSummary d) {
        ...
        html.append("""
                ...
                *{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--ink);font:15px/1.5 system-ui,-apple-system,"Segoe UI",sans-serif}
                ...
                .append(escape(d.baseDate())).append("\"></label><button type=\"submit\">조회</button><button type=\"button\" id=\"refresh\">새로고침</button><label class=\"toggle\"><input type=\"checkbox\" id=\"autoRefresh\"> 60초 자동 새로고침</label></form>");
        ...
        listCard(html, "Recommended Actions", "actions", d.recommendedActions(), "없음 — 권장 조치가 없습니다.");
