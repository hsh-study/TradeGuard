...
| 장초반 매매 후보 | 부분 완료 | 08:30 시장 순위와 fake 전일 시간외 강도 기반 EARLY_MARKET_PRE_SCAN 최대 10개, 09:05 snapshot 기반 EARLY_MARKET_ENTRY_CANDIDATE 최대 3개, 수동 API/scheduler/Discord/실행 이력/metrics 구현. signalId별 수동 성과 캡처/조회와 신호 점수 비교 구현. KIS 실제 시간외 adapter, 09:30 자동 캡처 scheduler, 1분봉/5분봉 기반 정확한 구간 성과는 TODO |
