...
| 모의 주문 | 부분 완료 | 저장 신호 기반 요청 API, 승인/거절 결과, DB 예약 후 FakeBroker 호출 흐름 존재 |
...
1. 거래 신호 조회 API와 알림 구현
2. API validation과 공통 오류 응답 추가
3. Flyway migration과 MySQL Testcontainers 검증
